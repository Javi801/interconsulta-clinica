...
export const TEXT = {
  ...
  psych: {
    ...
    suggestion: {
      ...
      subtitle: 'Escala SAD PERSONS calculada a partir de ambos formularios.',
      scoreLabel: (score: number, band: string) => `${band} · ${score}/10`,
      confirmValid: 'La sugerencia está correcta',
      confirmInvalid: 'Ajusté ítems manualmente',
      overriddenTag: 'Ajustado manualmente',
