...
export const SEED_PATIENT_FORMS: Record<string, PatientForm> = {
  '12.345.678-5': {
    general: {
      ...
      phone: '+569 1234 5678',
      email: 'daniela.perez@example.cl',
      occupations: ['Trabaja'],
  ...
  '11.222.333-4': {
    general: {
      ...
      phone: '+569 2222 3333',
      email: 'javiera.torres@example.cl',
  ...
  '20.111.222-8': {
    general: {
      ...
      relationshipStatus: 'Soltero/a',
      phone: '+569 2020 1122',
      email: 'nicolas.paredes@example.cl',
      occupations: ['Estudia'],
  ...
  '14.333.222-6': {
    general: {
      ...
      phone: '+569 1433 2226',
      email: 'teresa.valdes@example.cl',
      occupations: ['Trabaja'],
